...
[x] Task 6.3: 주문 생성 API ⭐⭐
    ...
    │  │  └─ 주문 생성 시 첫 번째 staff에게 자동 할당 ✅
    │  ├─ 8️⃣ delivery_task 자동 생성 (배달 대기 상태) ✅
    │  │  └─ 주문 생성 시 첫 번째 staff에게 자동 할당 ✅
    │  └─ OrderResponseDTO 반환 ✅
...
[x] Task 10.4: 요리 완료 시 재료 자동 차감 (매우 중요!) ⭐⭐⭐
    ├─ backend/src/main/java/com/softdinner/service/IngredientDeductionService.java ✅
    │  ├─ deductIngredientsForOrder(orderId, staffId) 메서드 ✅
...
- [x] Bundle 3: 인증 & 역할 구분 완료 (프론트엔드 UI 완료, 백엔드 API 구현 완료)
- [x] Bundle 4-7: 고객 주문 플로우 완료 (프론트엔드 UI 완료, 백엔드 API 구현 완료)
- [x] Bundle 8-9: staff 재료 관리 완료 (프론트엔드 UI 완료, 백엔드 API 구현 완료)
- [x] Bundle 10: 요리 진행도 관리 & 재료 자동 차감 완료 (프론트엔드 UI 완료, 백엔드 API 구현 완료)
- [x] Bundle 11: 배달 작업 관리 완료 (프론트엔드 UI 완료, 백엔드 API 구현 완료)
- [ ] Bundle 12: 음성 주문 완료
...
✅ **요리 진행도 관리 & 재료 자동 차감 (커스터마이징 포함)** (Bundle 10) ✅
✅ **배달 작업 관리** (Bundle 11) ✅  
✅ **주문 히스토리 조회** (Bundle 7)  
✅ **배달 날짜 지정** (Bundle 6)  
